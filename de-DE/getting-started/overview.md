...
<Callout type="info">
Kimi ist ein KI-Assistent von Moonshot AI – mit integrierter Websuche, vertieftem Denken, multimodalem Schlussfolgern und Unterhaltungen mit extrem langem Kontext.
</Callout>

Besuchen Sie [Kimi.com](https://www.kimi.com/) oder laden Sie die Kimi-App herunter, um zu chatten, zu erstellen, zu recherchieren und zu entwickeln. Entwickler finden auf der [Kimi Offene Plattform](https://platform.moonshot.ai/) APIs und Werkzeuge, um Kimis Fähigkeiten in ihre eigenen Anwendungen zu integrieren.
## Chat-Modi
| Modus | Beschreibung |
|------|-------------|
...
| **Kimi Code** | Auf Entwickler zugeschnittene Suite für Programmierhilfe, einschließlich CLI-Werkzeug und VS Code-Erweiterung | [kimi.com/code](https://www.kimi.com/code?from=kfc_overview_topbar) |
...
- **Dateiverarbeitung**: Unterstützt PDF, Word, Excel, PPT, Bilder, TXT und Video (jeweils bis zu 100 MB), mit maximal 50 Dateien pro Sitzung
- **Voreinstellungen**: Speichern Sie Ihre häufig genutzten Prompts für schnellen Zugriff – ideal für hochwertige, wiederverwendbare Prompt-Vorlagen
...
Nutzen Sie Kimi direkt im Browser unter [kimi.com](https://www.kimi.com/) – ganz ohne Download.
### Mobil
...
Laden Sie die Kimi-App für iOS, Android oder HarmonyOS herunter.
