...
Starten Sie Claude nach der Installation nicht direkt. Führen Sie zunächst das folgende Skript im Terminal aus, um den Standard-Anmeldevorgang von Anthropic zu überspringen:
...
Legen Sie anschließend die Umgebungsvariablen fest und starten Sie:
...
- Bei der Verwendung muss die echte Identität des Tools beibehalten werden; das Fälschen der Client-Kennung (User-Agent) gilt als Verstoß und kann zur vorübergehenden Sperrung der Mitgliedschaftsvorteile führen.
