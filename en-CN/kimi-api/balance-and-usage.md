...
<SeoMeta
  title="How do I check my Kimi API balance and usage? - Kimi Help Center"
  description="Learn how to view your API account balance, historical usage, and billing details in the Kimi Open Platform, keep track of credit usage, and top up in time to avoid service interruptions."
/>
