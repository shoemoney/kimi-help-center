...
**Beta Access**: K2.6 Agent Swarm [Beta] is currently available to Moderato, Allegretto, Allegro, and Vivace members. Tasks consume significantly more credits than standard Agent tasks.
</Callout>
