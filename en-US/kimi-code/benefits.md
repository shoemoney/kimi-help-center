...
- Kimi Code **shares the same credits as your Kimi membership plan** — requests from the CLI, VS Code, and third-party tools all count toward them; different plans include different credit amounts.
