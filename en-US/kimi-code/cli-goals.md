...
preview: true
preview_content: "Use goals to keep Kimi Code working toward a defined outcome across turns."
---

<SeoMeta
  title="Goals - Kimi Help Center"
  description="Use /goal to keep Kimi Code working toward a defined outcome across turns. Learn when to use goals, how to manage their lifecycle, and how to queue upcoming goals."
/>
...
Use goals for work with a clear finish line and verifiable evidence.
...
Use goals when the task may need several turns of investigation and repair.
...
Use goals for ordered work that should continue without another prompt.
...
Do not use goals for broad topics or open-ended discussions.
...
Do not use goals for tasks that are known to be impossible or unresolvable.
...
Do not use goals with ambiguous or complicated objectives.
