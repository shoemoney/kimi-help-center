...
|---|---|---|---|
| **K2.6** | Standard / Advanced | 快速 conversations and Q&A, with faster responses | **No membership credits used** |
...
- **K3** can produce editable documents end to end, such as `.pptx`, `.docx`, `.xlsx`, and `.pdf`; **K2.6** is optimized for 快速 Q&A and outputs text only, such as PPT outlines, Word body text, code, and more.
...
- **快速 Q&A and everyday conversations** → K2.6 (does not use credits).
...
K2.6 is optimized for 快速 Q&A, responds faster, and does not use membership credits. K3 has the strongest overall capability, excels at complex conversations and Agent tasks, can produce editable documents end to end, and is billed against credits.
