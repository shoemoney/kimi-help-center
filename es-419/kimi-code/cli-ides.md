...
<Callout type="info">
Kimi Code CLI admite la integración en IDE mediante el [Agent Client Protocol (ACP)](https://agentclientprotocol.com/), lo que te permite usar la programación asistida por IA directamente dentro de tu editor.
</Callout>
