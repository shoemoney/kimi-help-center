...
- Kimi provisionne automatiquement le modèle K3, associe vos crédits (credits) Kimi Code et active Kimi Web Search — aucune configuration API distincte n'est requise.
