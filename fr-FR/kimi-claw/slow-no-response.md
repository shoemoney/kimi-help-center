---
title: "Pas de réponse ou lenteur ?"
...
# Pas de réponse ou lenteur ?

<Callout type="info">
Si Kimi Claw ne répond pas ou se montre anormalement lent, plusieurs causes sont possibles. Suivez la démarche de dépannage ci-dessous.
</Callout>
...
Suivez ces étapes dans l'ordre jusqu'à ce que le problème soit résolu :
...
## À propos de la restauration des paramètres initiaux

<Callout type="warning">
Cette opération réinitialise Kimi Claw à son état d'usine, mais :

- **Conservé :** les fichiers de l'espace de travail et la mémoire à long terme
- **À reconfigurer :** les connexions aux plateformes de messagerie (Telegram, etc.) doivent être rétablies
</Callout>
