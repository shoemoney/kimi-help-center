...
|------|---------|---------|-------------|
| **Kimi Code** | Compatible Anthropic : `https://api.kimi.com/coding/` | Abonnement Kimi (inclut le quota) | [Console Kimi Code](https://www.kimi.com/code/console) |
...
Si vous utilisez la plateforme Kimi Code, vous pouvez vérifier votre quota actuel et l'état de votre abonnement via la commande `/usage`. Si votre quota est épuisé ou votre abonnement expiré, vous devez le renouveler ou passer à une offre supérieure sur [Kimi Code](https://kimi.com/code).
