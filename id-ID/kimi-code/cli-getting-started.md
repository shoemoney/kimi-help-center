...
|------|---------|---------|-------------|
| **Kimi Code** | Kompatibel OpenAI: `https://api.kimi.com/coding/v1`<br> Kompatibel Anthropic: `https://api.kimi.com/coding/` | Langganan keanggotaan Kimi (termasuk quota) | [Konsol Kimi Code](https://www.kimi.com/code/console) |
