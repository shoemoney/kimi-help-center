...
<Callout type="tip">
Per i prezzi dettagliati, consulta [platform.moonshot.ai/docs/pricing/chat](https://platform.moonshot.ai/docs/pricing/chat).
</Callout>
...
1. Accedi alla console [platform.moonshot.ai](https://platform.moonshot.ai).
