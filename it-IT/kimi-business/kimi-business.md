...
| Uso su larga scala di API / token | Acquista l'API sulla piattaforma aperta | [Kimi API Platform](https://platform.kimi.ai/) | [Contatta il team commerciale (modulo)](https://platform.kimi.ai/contact-sales) |
