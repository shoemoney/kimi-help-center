...
<Callout type="info">
La CLI di Kimi Code supporta l'integrazione negli IDE tramite l'[Agent Client Protocol (ACP)](https://agentclientprotocol.com/), consentendoti di sfruttare la programmazione assistita dall'AI direttamente nel tuo editor.
</Callout>
...
L'adattatore ACP generico di Paseo non gestisce il flusso di login, quindi completa prima il login da terminale (vedi [Prerequisiti](#prerequisites)); altrimenti la creazione della sessione fallirà con `Authentication required`.
