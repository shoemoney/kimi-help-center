...
- Web / モバイル：設定 → パーソナライズ → Memory Space（メモリースペース）
...
### メモリーを更新する
プロフィール → 設定 → パーソナライズ → Memory Space（メモリースペース）に移動すると、個別のメモリー項目を編集できます。

### メモリーを削除（忘却）する
プロフィール → 設定 → パーソナライズ → Memory Space（メモリースペース）に移動し、個別の項目で削除をクリックします。
