...
<Callout type="info">
Kimi API の請求、料金、お支払いに関するよくある質問です。
</Callout>
...
## どの支払い方法に対応していますか？
API コンソールでは、以下のお支払い方法をご利用いただけます。
| 方法 | 詳細 |
| --- | --- |
| **クレジットカード／デビットカード** | Visa、Mastercard などの主要カード |
| **銀行振込** | 組織認証済みユーザーは銀行振込を申請できます。銀行口座情報については営業担当までお問い合わせください |
