...
<SeoMeta
  title="Kimi Claw Android 概要 - Kimi Help Center"
...
Privacy Policy とユーザー契約に同意を選択してから、次に進みます。
...
- Kimi 会話を使用 — Kimi App を開き、Kimi Claw Android に対応する会話画面を開いて、対応する Claw に自動で切り替えます。
...
- ユーザー契約: ユーザー契約を読む
- Privacy Policy: Privacy Policy を読む
