...
- **ブラウザサイドバー**: ツールバーの Kimi アイコンをクリックしてサイドバーを開き、Kimi アカウントでログインすると、直接チャットでき、Kimi に現在のページの操作を任せられます。
...
2. アドレスバーで拡張機能管理ページを開きます（Chrome: `chrome://extensions/`、Edge: `edge://extensions/`）
