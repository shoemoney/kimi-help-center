...
<SeoMeta
  ...
  description="Kimi Work（ベータ版）について紹介します。Kimi Code を基盤とする、ナレッジワーカー向けの汎用ローカルエージェントです。スキル、スケジュールタスク、WebBridge、Agent Swarm、長期タスク実行に対応し、Mac / Windows クライアントで利用できます。"
/>
