...
Kimiには、無料プランを含む5つのメンバーシップランクがあります。日々の作業効率化からヘビーユーザー向けのワークフローまで、用途に合わせて選べます。すべてのプランには**2つのcreditプール**が含まれます。Kimi Codeは専用のquotaプールを使用し、その他のメンバーシップ機能は1つのquotaプールを共有します。
...
- **2つのcreditプール** — Kimi Codeは専用のquotaプールを使用し、その他のメンバーシップ機能は1つのquotaプールを共有します。利用量はtoken使用量に基づいて計測されます。
