...
preview: true
preview_content: "K2.6 Agent의 자율 작업 실행, 20개 이상의 도구, 지원되는 활용 사례를 알아보세요."
---
...
Kimi K2.6 Agent는 복잡한 작업을 처음부터 끝까지 처리하는 자율형 AI 어시스턴트입니다. K2.6 모델을 기반으로 20개 이상의 도구를 활용해 웹사이트 제작, 문서 생성, 데이터 분석 등을 수행합니다.
...
| **K2.6 Agent Swarm** | 최대 300개의 하위 에이전트가 병렬 작업 |
