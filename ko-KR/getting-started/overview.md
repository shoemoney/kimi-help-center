...
| 모델 | 사고 강도 | 적합한 용도 |
|-------|-------------------|----------|
| **K2.6** | Standard / High | 빠른 응답으로 신속한 대화와 Q&A |
| **K3** | Low / High / Max | 채팅과 Agent 작업 모두에 강하며, 전반적으로 가장 강력한 모델 |
| **K3 Swarm** | Low / High / Max | 대규모 검색과 일괄 처리를 한 번에 완료 |
...
- **파일 처리**: PDF, Word, Excel, PPT, 이미지, TXT, 동영상(각 최대 100 MB)을 지원하며, 세션당 최대 50개 파일을 사용할 수 있습니다
- **프리셋**: 자주 쓰는 프롬프트를 저장해 빠르게 사용할 수 있습니다. 품질 높은 재사용 프롬프트 템플릿에 특히 유용합니다
...
[kimi.com](https://www.kimi.com/)에서 브라우저로 바로 Kimi를 사용하세요. 다운로드가 필요 없습니다.
### 모바일
...
iOS, Android 또는 HarmonyOS용 Kimi 앱을 다운로드하세요.
