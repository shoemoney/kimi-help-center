...
설치 후 Claude를 바로 시작하지 마세요. 먼저 터미널에서 다음 스크립트를 실행하여 Anthropic의 기본 로그인 절차를 건너뜁니다:
...
- 사용 시 도구의 실제 신원을 유지해야 합니다. 클라이언트 식별자(User-Agent)를 위조하는 행위는 위반으로 간주되어 멤버십 혜택이 정지될 수 있습니다.
