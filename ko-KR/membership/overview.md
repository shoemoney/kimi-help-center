...
Kimi는 무료 플랜을 포함한 다섯 가지 멤버십 등급을 제공하여, 일상적인 업무 처리부터 파워 유저의 워크플로까지 다양한 요구에 맞춰 확장할 수 있습니다. Agent 기능과 기타 Kimi 멤버십 기능은 하나의 크레딧 풀을 공유하며, Kimi Code는 별도의 크레딧 풀을 사용합니다. K2.6은 크레딧을 차감하지 않습니다.
...
\* 일반적인 작업의 토큰 소모량을 기준으로 한 대략적인 수치입니다. 월별 크레딧을 동일 기능에 대한 작업 횟수로 환산한 값으로, 참고용입니다.
...
- **크레딧 풀** — Agent 기능과 기타 Kimi 멤버십 기능은 하나의 크레딧 풀을 공유하며, Kimi Code는 토큰 사용량에 따라 측정되는 별도의 크레딧 풀을 사용합니다.
- **월별 갱신** — 크레딧은 각 청구 주기가 시작될 때 초기화됩니다.

## 연간 결제로 절약하세요

연간 결제로 전환하면 최대 **연 $480**를 절약할 수 있습니다. 자세한 내용은 [요금 상세](/membership/membership-pricing)를 참고하세요.

<ColumnsContent
  columns={[
    {
      title: "크레딧 규칙",
      description: "크레딧의 작동 및 갱신 방식",
