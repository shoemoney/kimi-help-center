...
**Acesso Beta**: o K2.6 Agent Swarm [Beta] está atualmente disponível para os assinantes Allegretto, Allegro e Vivace. As tarefas consomem consideravelmente mais quota do que as tarefas padrão do Agent.
</Callout>
