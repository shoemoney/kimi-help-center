...
<SeoMeta
  title="Casos de uso e biblioteca de prompts do Deep Research - Central de Ajuda Kimi"
  description="Explore os casos de uso típicos do Kimi Deep Research, incluindo análise de setor, pesquisa de concorrentes, tendências de mercado e revisões de literatura acadêmica, com exemplos práticos de prompts para você começar rapidamente."
/>
