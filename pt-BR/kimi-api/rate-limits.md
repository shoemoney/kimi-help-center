...
- **Fale com a equipe de vendas**: Para requisitos especiais, entre em contato com a equipe de vendas da plataforma em [platform.moonshot.ai/contact-sales](https://www.platform.moonshot.ai/contact-sales) e solicite uma quota personalizada.
