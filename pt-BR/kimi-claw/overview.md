...
- O Kimi provisiona automaticamente o modelo K2.6 Thinking, conecta seus credits do Kimi Code e ativa o Kimi Web Search — sem necessidade de configuração de API separada.
