...
- O Kimi provisiona automaticamente o modelo K3, conecta seus créditos do Kimi Code e ativa o Kimi Web Search — sem necessidade de configuração de API separada.
