...
<Callout type="tip">
Você pode gastar todo o seu pool de créditos em um único recurso. Tenha em mente que isso deixará menos créditos disponíveis para tudo o mais — e o Kimi Code tem seu próprio rate limit separado de 5 horas / semanal, que não é afetado de nenhuma forma.
</Callout>
...
<ColumnsContent
  columns={[
    {
      title: "Regras de créditos",
      description: "Como os créditos funcionam e são renovados",
      pageUrl: "/membership/update-rules",
      type: "document",
    },
    {
      title: "Detalhes de preços",
      description: "Preços mensais e anuais",
      pageUrl: "/membership/membership-pricing",
      type: "data",
    },
    {
      title: "Alterações de plano",
      description: "Faça upgrade ou downgrade do seu plano",
