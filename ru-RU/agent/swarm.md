...
**Доступ к бета-версии**: сейчас K2.6 Agent Swarm [бета] доступен участникам Allegretto, Allegro и Vivace. Задачи расходуют значительно больше quota, чем стандартные задачи Agent.
</Callout>
