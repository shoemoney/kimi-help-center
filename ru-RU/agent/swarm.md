...
**Доступ к бета-версии**: сейчас K2.6 Agent Swarm [бета] доступен участникам Moderato, Allegretto, Allegro и Vivace. Задачи расходуют значительно больше кредиты, чем стандартные задачи Agent.
</Callout>
