...
- При использовании сохраняйте подлинную идентификацию инструмента — подмена идентификатора клиента (User-Agent) будет считаться нарушением и может привести к приостановке действия ваших членских преимуществ.
