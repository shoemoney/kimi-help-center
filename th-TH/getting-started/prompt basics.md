...
<SeoMeta
  title="พื้นฐานการเขียนพรอมต์ - ศูนย์ช่วยเหลือ Kimi"
  ...
  files={[
    {
      name: "prompt.txt",
      language: "text",
      content: "เขียน [ประเภทบทความ] เกี่ยวกับ [หัวข้อ] สำหรับ [กลุ่มเป้าหมาย] ความยาวประมาณ [xxx] คำ\nข้อกำหนด: [สไตล์/รูปแบบ/ประเด็นที่เน้น]",
    },
  ]}
/>
  ...
  files={[
    {
      name: "prompt.txt",
      language: "text",
      content: "วิเคราะห์ [หัวข้อ] โดยเน้นที่ [มิติสำคัญ]\nรูปแบบผลลัพธ์: [ตาราง/แผนภูมิ/รายงาน]\nรวมข้อสรุปและคำแนะนำ",
    },
  ]}
/>
  ...
  files={[
    {
      name: "prompt.txt",
      language: "text",
      content: "แปลข้อความต่อไปนี้เป็น [ภาษาปลายทาง] โดยคงโทน [วิชาการ/สนทนา/ธุรกิจ]\nสำหรับศัพท์เฉพาะทาง ให้ระบุคำศัพท์ต้นฉบับไว้ในวงเล็บ",
    },
  ]}
/>
