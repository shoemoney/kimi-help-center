...
อะแดปเตอร์ ACP ทั่วไปของ Paseo จะไม่ดำเนินการตามขั้นตอนการเข้าสู่ระบบ ดังนั้นให้เข้าสู่ระบบผ่านเทอร์มินัลให้เสร็จก่อน (ดู [สิ่งที่ต้องเตรียม](#สิ่งที่ต้องเตรียม)) — มิฉะนั้นการสร้างเซสชันจะล้มเหลวพร้อมข้อความ `Authentication required`
