...
- เมื่อใช้งาน โปรดคงไว้ซึ่งตัวตนที่แท้จริงของเครื่องมือ การปลอมแปลงตัวระบุไคลเอนต์ (User-Agent) จะถือเป็นการละเมิดและอาจทำให้สิทธิประโยชน์สมาชิกของคุณถูกระงับ
