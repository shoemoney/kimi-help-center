...
- **แถบด้านข้างของเบราว์เซอร์**: คลิกไอคอน Kimi ในแถบเครื่องมือเพื่อเปิดแถบด้านข้าง จากนั้นเข้าสู่ระบบด้วยบัญชี Kimi ก็สามารถสนทนาได้โดยตรงและให้ Kimi จัดการหน้าเว็บปัจจุบันแทนคุณ
...
หากคุณไม่สามารถเข้าถึงเว็บสโตร์ได้ คุณสามารถใช้วิธีติดตั้งด้วยตนเองได้ ขั้นตอนสำหรับ Chrome และ Edge เหมือนกัน:

1. ดาวน์โหลดแพ็กเกจส่วนขยายจาก [เว็บไซต์ทางการของ ส่วนขยายเบราว์เซอร์ Kimi](https://www.kimi.com/features/webbridge) และแตกไฟล์ที่ดาวน์โหลดมา
2. เปิดหน้าส่วนขยายในแถบที่อยู่:
   - Chrome: `chrome://extensions/`
   - Edge: `edge://extensions/`
3. เปิดใช้งาน "โหมดนักพัฒนา" (Chrome อยู่ที่มุมขวาบน ส่วน Edge อยู่ที่มุมซ้ายล่าง)
4. คลิก "โหลดแบบแตกไฟล์แล้ว"
5. ในตัวเลือกไฟล์ ให้เลือกโฟลเดอร์ WebBridge ที่แตกไฟล์ไว้

<Frames
  src="./images/installation_chrome_en.png"
  alt="ขั้นตอนการติดตั้งด้วยตนเองแสดงใน Chrome อินเทอร์เฟซของ Edge เหมือนกันโดยพื้นฐาน"
/>
...
2. เปิดแอป Kimi Work เดสก์ท็อปที่ดาวน์โหลดมา แล้วสลับไปยังโหมด Work ค้นหาและติดตั้ง ส่วนขยายเบราว์เซอร์ Kimi ในตลาดปลั๊กอิน จากนั้นลองส่งคำสั่งด้านล่างในแถบด้านข้างของเบราว์เซอร์ หรือใน Kimi Work:
