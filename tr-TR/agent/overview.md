...
| Özellik | Açıklama |
|---------|-------------|
| **Web siteleri** | Duyarlı web uygulamaları oluşturun ve yayına alın |
| **Belgeler** | Word, PDF, Markdown düzenleme ve oluşturma |
...
4. **Hata Yönetimi**: Kullanıcı müdahalesi olmadan kendini düzeltir
5. **Çıktılar**: Office dosyaları, web uygulamaları veya raporlar
...
- Web sitesi geliştirme (hiç kod yazmadan)
- Çoklu ortam içeren içerik üretimi
- Belge karşılaştırma ve çeviri
- Veri analizi (1.000 satıra kadar Excel)
- Slayt oluşturma
- Belge dönüştürme
...
<ColumnsContent
  columns={[
    ...
    {
      title: "Kimi Claw",
      description: "Bulut otomasyon aracısı",
