...
preview: true
preview_content: "Başlamak için Kimi'nin modellerini, yapay zeka ajanlarını, dosya işleme özelliklerini ve arayüz rehberini keşfedin."
---

<SeoMeta
  title="Kimi'ye genel bakış - Kimi Yardım Merkezi"
  description="Başlamak için Kimi'nin modellerini, yapay zeka ajanlarını, dosya işleme özelliklerini ve arayüz rehberini keşfedin."
/>
...
<Callout type="tip">
İnternette arama yapılıp yapılmayacağına Kimi, sorunuza göre otomatik olarak karar verir — elle bir açma/kapama gerekmez.
</Callout>
...
|-------|-------------|------|
| **Genel Agent** | Web sitesi oluşturma, slayt hazırlama, Deep Research, belge ve elektronik tablo işleme dahil olmak üzere görevleri otomatik olarak planlar ve tamamlar | [kimi.com/agent](https://www.kimi.com/agent) |
