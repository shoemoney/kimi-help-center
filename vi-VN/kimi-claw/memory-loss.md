...
**Cách làm tốt nhất:** Với bất cứ điều gì quan trọng — sở thích, chi tiết dự án, các chỉ dẫn lặp lại — hãy yêu cầu Kimi Claw lưu lại một cách rõ ràng: _"Hãy ghi nhớ điều này vào bộ nhớ."_ Thông tin lưu trong bộ nhớ sẽ được giữ lại qua các lần đặt lại cuộc trò chuyện.

## Kimi Claw bị mất bộ nhớ?

Lần đặt lại lúc 4 giờ sáng mỗi ngày sẽ xóa ngữ cảnh cuộc trò chuyện đang hoạt động. Nếu một điều gì đó chưa được lưu vào **bộ nhớ**, nó sẽ mất.

**Cách khắc phục:**
- Trong cuộc trò chuyện, hãy nói _"Hãy ghi nhớ X vào bộ nhớ"_ và Kimi Claw sẽ ghi vào bộ nhớ dài hạn.
- Xem lại các bộ nhớ đã lưu qua **Không gian làm việc → AGENTS.md → #MEMORY**.
...
Các tệp bộ nhớ nằm trong không gian làm việc của bạn, và bạn có thể xem hoặc tải xuống bất cứ lúc nào.
