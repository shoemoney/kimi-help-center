...
Đầu tiên, <a class="leading-7 text-(--Colors-KMBlue) decoration-(--hc-pill-border) decoration-2 transition-colors hover:text-(--Colors-KMBlue-hover)" href="https://www.kimi.com/products/kimi-work">tải xuống và cài đặt Kimi Work</a>. Chuẩn bị các nội dung sau:
