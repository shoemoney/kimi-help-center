...
<Frames
  src="./images/skills/skill示意图.png"
  alt="skill是什么示意图"
/>

## 使用方式

对话开始时， Agent（智能体）将看到可用技能列表及其名称与简介。若某项技能与当前任务相关，智能体会读取完整说明并遵照执行。
...
当你发起一个请求，Kimi Agent 会判断当前任务是否涉及某个技能，若涉及则自动加载对应技能，并按其中的指令完成任务。
