...
「席位」可以理解为企业版的使用名额。一个席位对应一个企业成员账号使用企业版权益，通常与企业组织下的成员账号绑定，管理员可在企业成员范围内分配和管理席位。

## 企业版与个人版的区别是什么？

企业版主要面向团队 / 公司采购使用，和个人版相比，核心区别在于：有数据安全承诺，企业数据不用于模型训练；支持企业采购流程、合同、开票等。
...
企业版目前是按年付费，没有优惠和折扣，支持开票，增值税普通发票和增值税专用发票均可。
