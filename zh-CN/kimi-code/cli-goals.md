  ...
  files={[
    {
      name: "prompt.txt",
      language: "text",
      content: "/goal 修复项目的 GitHub 的 issues 中列出的 bug",
    },
  ]}
/>
  ...
  files={[
    {
      name: "prompt.txt",
      language: "text",
      content: "/goal 修复所有标签关于结算系统的回退的漏洞，为每个修复新增或更新测试，最后运行所有有关结算的测试套件",
    },
  ]}
/>
  ...
  files={[
    {
      name: "prompt.txt",
      language: "text",
      content: "/goal 修复所有失败的结算测试，并确保可以成功运行有关结算的测试套件",
    },
  ]}
/>
  ...
  files={[
    {
      name: "prompt.txt",
      language: "text",
      content: "/goal 找出发行版构建失败的原因，修复最本质的原因，并确认构建通过",
    },
  ]}
/>
  ...
  files={[
    {
      name: "prompt.txt",
      language: "text",
      content: "/goal 更新功能实现，补充文档，运行测试，并总结变更文件",
    },
  ]}
/>
  ...
  files={[
    {
      name: "prompt.txt",
      language: "text",
      content: "/goal 用单个 HTML 文件创建一个电子游戏。",
    },
  ]}
/>
  ...
  files={[
    {
      name: "command.sh",
      language: "bash",
      content: "kimi -p \"/goal 修复 checkout 测试失败\"",
    },
  ]}
/>
