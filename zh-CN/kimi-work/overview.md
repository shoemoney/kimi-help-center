...
<SeoMeta
  ...
  description="了解 Kimi Work（Beta）：面向知识工作者的通用型本地 Agent，以 Kimi Code 为内核、搭载 Kimi K3 模型，支持技能、定时任务、WebBridge、Agent 集群、小组件与看板，在 Mac / Windows 客户端使用。"
/>
...
- **小组件（Widgets）**：在会话中由模型即时生成的可交互页面，可连接本地数据或外部插件持续更新，让答案更直观、更好理解。详见[小组件](/kimi-work/widgets)。
- **看板（Dashboard）**：将你最关心的小组件汇总到一个持久的个性化视图，围绕主题、项目或目标组织，随时查看和管理。详见[看板](/kimi-work/dashboard)。
