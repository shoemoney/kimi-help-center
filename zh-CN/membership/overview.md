...
<Callout type="tip">
- **支持同花顺、天眼查等付费数据库**：涵盖金融、经济、学术领域数据源。
- **Agent 集群**：多 Agent 并行、数倍生产力，适用海量搜索、长文写作、批量处理。
</Callout>
...
| 定制化看板 | ✅ | ✅ | ✅ | ✅ |
| 定时任务 | 6 个任务 | 10 个任务 | 15 个任务 | 20 个任务 |
| 小组件任务 | 6 个任务 | 10 个任务 | 15 个任务 | 20 个任务 |
| 项目数 | 20 个项目 | 20 个项目 | 20 个项目 | 100 个项目 |
| 项目存储空间 | 20GB | 20GB | 20GB | 50GB |
| 精选插件 | 15+ 种可调用 | 15+ 种可调用 | 15+ 种可调用 | 15+ 种可调用 |
| 集群功能 | — | ✅ | ✅ | ✅ |
