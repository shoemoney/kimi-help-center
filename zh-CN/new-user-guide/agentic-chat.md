...
<SeoMeta
  ...
  description="了解 Kimi 的三档模型（K2.6 Fast、K3、K3 集群）、内置工具与多模态能力，快速上手对话与任务执行。"
/>
...
<Callout type="tip">
K2.6 Fast 不消耗会员额度；K3 与 K3 集群按额度计费，详见[会员权益说明](https://www.kimi.com/help/membership/membership-overview)。
</Callout>
...
<Callout type="tip">
小提示：如需生图、生成复杂可编辑文档或执行多步任务，推荐选择 **K3** 或 **K3 集群**，体验更完整。
</Callout>
