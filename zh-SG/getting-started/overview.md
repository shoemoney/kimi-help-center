...
preview: true
preview_content: "了解 Kimi 的聊天模式、AI 智能体、文件处理能力与界面指南，快速上手。"
---

<SeoMeta
  title="Kimi 概览 - Kimi 帮助中心"
  description="了解 Kimi 的聊天模式、AI 智能体、文件处理能力与界面指南，快速上手。"
/>
...
| 模式 | 说明 |
|------|-------------|
| **网页搜索（自动/关闭）** | 连接互联网，获取实时信息和网页搜索结果 |
| **K2.6 Instant** | 快速回答一般问题 |
| **K2.6 Thinking** | 进行更深入的多步推理和搜索，适合编程、逻辑或分析类任务 |

<Callout type="tip">
如果只是基于文档进行简单问答，可以同时关闭网页搜索和 Thinking mode。
</Callout>
