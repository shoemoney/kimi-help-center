...
| 404 | 资源不存在（Not Found） | 请检查请求的 URL 路径和模型名称是否正确，并确认接口地址为 `https://api.moonshot.ai/v1/...`。 |
...
3. **参考官方文档**：请确保调用方式与 [platform.kimi.ai](https://platform.kimi.ai/docs/guide/start-using-kimi-api) 文档一致。
