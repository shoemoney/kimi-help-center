...
| 模式 | 說明 |
|------|-------------|
| **Web Search（自動/關閉）** | 連接網際網路，取得即時資訊與 Web Search 結果 |
| **K2.6 Instant** | 快速回答一般問題 |
| **K2.6 Thinking** | 更深入的多步驟推理與搜尋，適合程式開發、邏輯推演或分析型任務 |

<Callout type="tip">
若只是針對文件進行簡單問答，可同時關閉 Web Search 與 Thinking mode。
</Callout>
