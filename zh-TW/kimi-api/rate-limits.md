...
API 速率限制會依帳戶的**累計儲值金額**分級；儲值金額越高，可用的速率限制也越高。具體分級標準，以及對應的 RPM（每分鐘請求數）、TPM（每分鐘 token 數）限制，請參考 [platform.kimi.com/](https://platform.kimi.com/) 控制台中的說明。
...
- **聯絡客服**：如有特殊需求，可聯絡平台客服，或透過 [platform.kimi.com/](https://platform.kimi.com/) 聯絡銷售團隊，申請客製化的速率 quota。
