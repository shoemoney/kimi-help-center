...
「席位」可以理解為企業方案的使用名額。每個席位對應一個企業成員帳號使用 Kimi Business 權益。席位通常與企業組織下的成員帳號綁定，管理員可在組織成員範圍內分配與管理席位。

## 企業方案與個人方案的差異是什麼？

企業方案主要供團隊與公司採購使用。與個人方案相比，核心差異在於：具備資料安全承諾，企業資料不會用於模型訓練；並支援企業採購流程、合約與開立發票。
